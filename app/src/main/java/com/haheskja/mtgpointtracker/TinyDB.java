...
public class TinyDB {
    ...
    public ArrayList<Rule> getListObject(String key){
    	Gson gson = new Gson();
        ...
        for(String jObjString : objStrings){
    		Rule value  = gson.fromJson(jObjString, Rule.class);
    		objects.add(value);
    	}
    ...
    public void putListObject(String key, ArrayList<Rule> objArray){
    	checkForNullKey(key);
    	Gson gson = new Gson();
    	ArrayList<String> objStrings = new ArrayList<String>();
    	for(Rule obj : objArray){
